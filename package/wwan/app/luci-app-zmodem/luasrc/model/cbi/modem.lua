...
-- apn.description = translate("暂未实现")
-- apn.disabled = true
...
-- opera_mode:value("reboot_mode", translate("Reboot module on internet connection lost"))
...
-- if apply then
-- 	-- luci.sys.exec("/sbin/uci commit")
--     local cmd = "/usr/share/rm520n.sh &"
--     luci.sys.call(cmd)
-- end
